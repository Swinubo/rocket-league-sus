...
while not done:
    ...
    for event in pygame.event.get():
        ...
        LogInDisp = pygame.image.load("C:\\Users\\fmend\\Documents\\Gaspar\\Python Projects\\Images\\LogIn.png").convert()
        LogInDispl = pygame.transform.scale(LogInDisp, RECT_IMAGE_SIZE)

        CreateAccountDisp = pygame.image.load("C:\\Users\\fmend\\Documents\\Gaspar\\Python Projects\\Images\\CreateAccount.png").convert()
