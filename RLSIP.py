...
image_path = pathlib.Path(current_dir, 'Images')
...
while not done:
    ...
    for event in pygame.event.get():
        ...
        PlayersDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\Players.jpg").convert()
        PlayersDispl = pygame.transform.scale(PlayersDisp, DEFAULT_IMAGE_SIZE)
        
        PlayDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\Play.jpg").convert()
        PlayDispl = pygame.transform.scale(PlayDisp, PLAY_IMAGE_SIZE)

        HomeDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\Home.png").convert()
        HomeDispl = pygame.transform.scale(HomeDisp, DEFAULT_IMAGE_SIZE)

        BoxBlueDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\BoxBlue.jpg").convert()
        BoxBlueDispl = pygame.transform.scale(BoxBlueDisp, BOX_IMAGE_SIZE)

        BoxRedDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\BoxRed.jpg").convert()
        BoxRedDispl = pygame.transform.scale(BoxRedDisp, BOX_IMAGE_SIZE)

        BoxYellowDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\BoxYellow.jpg").convert()
        BoxYellowDispl = pygame.transform.scale(BoxYellowDisp, BOX_IMAGE_SIZE)

        RonaldoDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\Ronaldo.png").convert()
        RonaldoDispl = pygame.transform.scale(RonaldoDisp, CARD_IMAGE_SIZE)

        MessiDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\Messi.png").convert()
        MessiDispl = pygame.transform.scale(MessiDisp, CARD_IMAGE_SIZE)

        NeymarDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\Neymar.png").convert()
        NeymarDispl = pygame.transform.scale(NeymarDisp, CARD_IMAGE_SIZE)

        PresidentDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\President.png").convert()
        ...
        # LogInDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\LogIn.png").convert()
        # LogInDispl = pygame.transform.scale(LogInDisp, RECT_IMAGE_SIZE)

        # CreateAccountDisp = pygame.image.load("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Images\\CreateAccount.png").convert()
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if ((x < 201) and (x > 0)):
                ...
                Accounts = open('C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Accounts.txt', 'r')
                ...
                with open("C:\\Users\\silgas\\Documents\\Gaspar\\Python Projects\\Accounts.txt", "a") as Accounts:
                    Accounts.write("\n" + str(Level) + ' ' + Name)
                    Accounts.close()
